...
const DUMMY_POSTS: MyPost[] = [
  ...
  ...Array.from({ length: 4 }, (_, i) => ({
    ...
    tags: [["DP", "Python"], ["그래프", "이진탐색"], ["시뮬레이션", "C++"], ["카카오", "Java"]][i],
      ...
      <div className="bg-white px-6 sm:px-8 py-4 sm:py-5 border-t border-gray-200 flex justify-between items-center">
        ...
        <div className="flex flex-wrap gap-1.5">
          {post.tags.map((pos) => (
            <span
              key={pos}
              className="bg-gray-100 text-gray-700 px-2 py-1 rounded text-[10px] font-medium"
            >
              {pos}
            </span>
          ))}
