...
interface ApplyFieldCheckboxGroupProps {
  value: string[];
  onChange: (value: string[]) => void;
  errorMessage?: string;
}

export default function ApplyFieldCheckboxGroup({
  value,
  onChange,
  errorMessage,
}: ApplyFieldCheckboxGroupProps) {
        ...
        {APPLY_FIELDS.map((field) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-base text-gray-900">{field}</span>
            </label>
          );
        })}
      </div>
