...
export default function DepartmentSelect({
  ...
  return (
    <div className="space-y-1.5">
      <label htmlFor="department-select" className="text-body-sm font-medium text-gray-900">
      ...
      {errorMessage && (
        <p id="department-error" className="text-xs text-notice flex items-center gap-1 mt-1">
