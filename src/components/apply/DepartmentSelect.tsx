    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <select
          ...
          aria-describedby={errorMessage ? "department-error" : undefined}
          className={`w-full appearance-none rounded-xl px-4 py-4 text-base font-medium tracking-[-0.048px] leading-normal border outline-none transition-all duration-150 cursor-pointer ${
