    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <select
          ...
          className={`w-full appearance-none rounded-lg px-4 py-[15px] text-base font-medium tracking-[-0.048px] leading-normal border text-gray-900 outline-none transition-all duration-150 cursor-pointer ${
            errorMessage
