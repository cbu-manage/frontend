...
export default function RecruitmentNotice() {
  return (
    <div className="rounded-xl border border-gray-200 bg-gray-50 px-7 py-5 space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[max-content_max-content_max-content] sm:justify-between gap-x-4 gap-y-2 text-base text-gray-900 whitespace-nowrap">
