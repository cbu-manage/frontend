...
// TODO: 세부 타입 추가
export type StudyListParams = { page?: number; size?: number };
export type StudyFilterParams = { tag?: string; page?: number; size?: number };

export const studyApi = {
  /** 스터디 게시글 전체 목록 페이징 조회 */
  ...
  /** 스터디 태그별 목록 페이징 조회 */
  getFilteredList: (params?: StudyFilterParams) =>
