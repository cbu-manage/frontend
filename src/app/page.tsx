  ...
  return (
    ...
    >
      <div className="text-center">
        <div className="text-[2.4rem] font-semibold text-neutral-900">
          <span className="text-[#95C674] font-semibold">씨부엉</span>에 오신 것을 환영합니다.
        </div>
        <p className="text-[1.6rem] text-neutral-600 mt-2 mb-9">
        ...
        {isAdmin ? (
          ...
          <button
            ...
            disabled
            className="px-6 py-3 rounded-full border border-zinc-300 bg-zinc-300 text-zinc-600 cursor-not-allowed text-base font-semibold"
          >
            신청기간이 아닙니다
          </button>
        )}
